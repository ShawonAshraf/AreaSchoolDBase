...
class Area_Model extends CI_Model {
        ...
        {
          $q_result = $this->db->query('SELECT a.AREA_NAME, s.SCHOOL_ID, s.SCHOOL_NAME, s.ESTD_YEAR, s.PUB_PVT, s.NUM_STUDENTS, s.NUM_TEACHERS, s.GOVERNMENT_PROJ
      ...
      public function getAllTeachers()
        {
          $q_result = $this->db->query('SELECT * FROM TEACHER');
          return $q_result->result_array();
        }
}
